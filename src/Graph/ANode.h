...
public:
    ...
    ANode(Node node , u_int lastNodeId , double totalWeight, double distToFinish);
    ANode(Node node, double totalWeight, double distToFinish);
    ANode(Node node, double distToFinish);
